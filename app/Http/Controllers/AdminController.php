...
class AdminController extends Controller
{
    ...
    public function inputdatabph(Request $request)
    {
        ...
        $mahasiswa = DB::table('mahasiswa')->where('npm', $request->npm)->first();

        if (!$mahasiswa) {
            // Jika mahasiswa belum ada, masukkan data ke dalam tabel 'mahasiswa'
        ...
        // Masukkan data ke dalam tabel 'detail_kepengurusan' menggunakan id_kepengurusan yang diperoleh
    ...
    public function proposaleksidentil(Request $request)
    {
        ...
        return view('admin/eksidentil', compact('proposal'));
    }
    ...
    public function detailtahunan($id)
    {
        ...
        return view('admin/detaillaporantahunan', ['laporan' => $laporan, 'id' => $id]);
    }



    //update laporan kegiatan dan tahunan
    public function updatelaporankemahasiswaan(Request $request, $id)
    {

        // Update status_dekanat di tabel detail_laporan
        DB::table('detail_laporan')
            ->where('id_laporan', $id)
            ->update(['status_kemahasiswaan' => $request->status_kemahasiswaan]);
