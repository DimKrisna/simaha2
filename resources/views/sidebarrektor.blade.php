        ...
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href= "{{ route('baca') }}" class="sidebar-link">
               ...
               <li class="sidebar-item">
                    ...
                    <ul id="proposal" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-item">
                        <li class="sidebar-item">
                            <a href="{{route('proposalkegiatanrektor')}}" class="sidebar-link">Kegiatan Proker</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{route('proposalinsidentilrektor')}}" class="sidebar-link">Kegiatan Insidentil</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('struktur1') }}" class="sidebar-link">
                        <i class="lni lni-folder"></i>
                        <span>Struktur</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('statis1') }}" class="sidebar-link">
