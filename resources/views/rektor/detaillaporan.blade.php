...
@section('content')
    <div class="container">
        ...
        <div class="form-container mt-4">
            ...
            <form action="{{ route('UpdateLaporanRektor', ['id' => $laporan->id_laporan]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group mb-4 p-3 border rounded shadow-sm bg-light">
                    <label for="status_wr3" class="form-label">Status Kemahasiswaan:</label>
                    <select class="form-select" id="status_wr3" name="status_wr3" required>
                ...
                <div class="form-group">
                    <label for="catatan_rektor" class="form-label">Catatan Rektor:</label>
                    <textarea name="catatan_rektor" id="catatan_rektor" class="form-control" rows="4">{{ $laporan->catatan_rektor }}</textarea>
                </div>
