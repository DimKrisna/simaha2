    ...
    <div class="container">
        ...
        <div class="form-container mt-4">
            ...
            <form action="{{ route('updatelaporan', $laporan->id_laporan) }}" method="POST">
                ...
                <label for="dana_terpakai"> Dana Terpakai:</label>
                <text id="dana_terpakai" name="dana_terpakai" rows="4" class="form-control" required>{{ $laporan->dana_terpakai }}</text>
                ...
                <!-- Akhir dari tampilan data dari query -->
                 ...
                 <!-- Tombol Submit dan Revisi -->
                    <div class="button-container">
                        <a class="btn btn-danger" href="{{ route('laporankegiatan') }}" role="button"><i
            ...
            <form action="{{ route('acclaporankegiatan', $laporan->id_laporan) }}" method="POST" class="mt-3">
                @csrf
