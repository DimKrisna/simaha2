        ...
        <aside id="sidebar">
            <div class="d-flex">
                ...
                <div class="sidebar-logo">
                    <a href="{{ route('ormawabishum') }}">SIMAHA</a>
                </div>
            </div>
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href= "{{ route('ormawabishum') }}" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="proposal" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-item">
                        <li class="sidebar-item">
                            <a href="{{ route('proposalkegiatanprokerbishum') }}" class="sidebar-link">Proker</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('proposalkegiataninsidentilbishum') }}" class="sidebar-link">Insidentil</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                    ...
                    <ul id="laporan" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="{{ route('laporankegiatanbishum') }}" class="sidebar-link">Kegiatan</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('laporantahunanbishum') }}" class="sidebar-link">Tahunan</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('monitoringkegiatanbishum') }}" class="sidebar-link">
