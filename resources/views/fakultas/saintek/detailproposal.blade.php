...
@section('content')
    <div class="container">
        ...
        <div class="form-container mt-4">
            ...
            <form action="{{ route('update.proposalFakultasSaintek', ['id' => $proposal->id_proposal]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-3 mt-4">
                    <!-- Back Button -->
                    <a class="btn btn-danger d-flex align-items-center" href="{{ route('proposalkegiatanprokerFST') }}"
                        role="button">
