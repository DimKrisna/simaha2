...
@section('content')
 <br>
    ...
    <div class="container border">
        <h1 class="text-center mt-5 mb-4">Data Himpunan Mahasiswa Fakultas Sains & Teknologi</h1>
        <div class="col-4"></div>
        <br><br>
        ...
        <!-- Pagination links for datafst -->
        <div class="d-flex justify-content-center">
            {{ $datafst->links('vendor.pagination') }}
        </div>
        <br>
    </div>
    ...
    <div class="container border">
            ...
            <tbody>
                @foreach ($dataProker as $proker)
                    <tr>
                        ...
                        <td>{{ $proker->status }}</td>
                        <td>
                            <a href="{{ route('detailProkerFakultas', Crypt::encryptString($proker->id_proker)) }}" class="btn btn-primary">
                                <i class="lni lni-eye" style="vertical-align: middle;"></i>
                                <span style="vertical-align: middle; margin-left: 2px;">Detail</span>
                            </a>
                        </td>
        ...
        <!-- Pagination links for dataProker -->
        <div class="d-flex justify-content-center">
            {{ $dataProker->links('vendor.pagination') }}
        </div>
