...
@section('content')
    <div class="container">
        ...
        <div class="form-container mt-4">
            ...
            <form action="{{ route('updatelaporan', ['id' => $laporan->id_laporan]) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    (masukan catatan revisi disini / hapus jika tidak ada revisi)</textarea>
                </div>
            ...
            <form action="{{ route('acclaporan', ['id' => $laporan->id_laporan]) }}" method="POST">
                @csrf
                @method('PUT')
