        ...
        <aside id="sidebar">
            <div class="d-flex">
                ...
                <div class="sidebar-logo">
                    <a href="{{ route('DataProdi') }}">SIMAHA</a>
                </div>
            </div>
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href= "{{ route('datakepengurusanormawa') }}" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="proposal" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-item">
                        <li class="sidebar-item">
                            <a href="{{ route('proposalkegiatanproker') }}" class="sidebar-link">Proker</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('proposalinsidentil') }}" class="sidebar-link">Insidentil</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                    ...
                    <ul id="laporan" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="{{ route('laporankegiatanprodi') }}" class="sidebar-link">Kegiatan</a>
                        </li>
                        <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('monitoringkegiatan') }}" class="sidebar-link">
                        <i class="lni lni-search-alt"></i>
                        <span>Monitoring Kegiatan</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('strukturprodi') }}" class="sidebar-link">
