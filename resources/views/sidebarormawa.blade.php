        ...
        <aside id="sidebar">
            <div class="d-flex">
                ...
                <div class="sidebar-logo">
                    <a href="{{ route('ormawa') }}">SIMAHA</a>
                </div>
            </div>
            <ul class="sidebar-nav">
                <li class="sidebar-item">
                    <a href= "{{ route('datapengurusormawa') }}" class="sidebar-link">
                        <i class="lni lni-layers"></i>
                        <span>Data <b>{{ Auth::user()->nama_singkatan }}</b></span>
                    </a>
                </li>
                <li class="sidebar-item">
                    ...
                    <ul id="proposal" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar-item">
                        <li class="sidebar-item">
                            <a href="{{ route('tampilkanPropProker') }}" class="sidebar-link">Proker</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('pengajuanpropinsidentil') }}" class="sidebar-link">Insidentil</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                    ...
                    <ul id="laporan" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="{{ route('laporan_kegiatan') }}" class="sidebar-link">Kegiatan</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('laporan_tahunan') }}" class="sidebar-link">Tahunan</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('tampilmonitoring') }}" class="sidebar-link">
                        <i class="lni lni-search-alt"></i>
                        <span>Monitoring Kegiatan</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('strukturormawa') }}" class="sidebar-link">
