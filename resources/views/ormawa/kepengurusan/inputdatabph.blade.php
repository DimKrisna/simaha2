...
@section('content')
    <div class="d-flex justify-content-center">
        <div class="col-md-6 ">
            <h2 class="mb-4 mt-3">Data Kepengurusan Inti Organisasi</h2>
    ...
    <script>
        ...
        // Fetch the name of mahasiswa based on NPM input
        document.getElementById('npm').addEventListener('input', function() {
            var npm = this.value;
            if (npm.length >= 8) {  // Pastikan panjang NPM valid, misal minimal 8
                fetch(`/get-nama-mahasiswa?npm=${npm}`)
                ...
                document.getElementById('nama_mahasiswa').value = ''; // Kosongkan jika NPM tidak valid
            }
        });
    </script>
@endsection
