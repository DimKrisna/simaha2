                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="catatan_prodi" id="catatan_prodi" class="form-control" placeholder="Masukkan catatan" rows="3"
                                    disabled>{{ $proposal->catatan_prodi ?? 'Tidak ada catatan' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="catatan_kemahasiswaan" id="catatan_kemahasiswaan" class="form-control" placeholder="Masukkan catatan"
                                    rows="3" disabled>{{ $proposal->catatan_kemahasiswaan ?? 'Tidak ada catatan' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="catatan_rektor" id="catatan_rektor" class="form-control" placeholder="Masukkan catatan" rows="3"
                                    disabled>{{ $proposal->catatan_rektor ?? 'Tidak ada catatan' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="catatan_fakultas" id="catatan_fakultas" class="form-control" placeholder="Masukkan catatan"
                                    rows="3" disabled>{{ $proposal->catatan_fakultas ?? 'Tidak ada catatan' }}</textarea>
                            </div>
                        </div>
        </div>
        ...
        <div class="button-container">
            <div class="form-group">
                ...
                <button type="button" class="btn btn-danger float-left" onclick="goBack()"><i
                        class="lni lni-arrow-left-circle" style="vertical-align: middle; margin-right: 2px;"></i><span
