    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('input_laporanLPJ') }}" method="POST" enctype="multipart/form-data">
                ...
                <label for="id_proposal">Kegiatan</label>
                <select name="id_proposal" id="id_proposal" class="form-control">
                <option value="">Pilih Proposal</option>
                   @foreach ($data as $d)
                      <option value="{{ $d->id_proposal }}">{{ $d->judul_kegiatan }}</option>
                   @endforeach
                </select>
                ...
                <input type="number" id="dana_terpakai" name="dana_terpakai" required>
